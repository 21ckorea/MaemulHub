...
let InquiryController = class InquiryController {
    ...
    list(page, pageSize, q, status, source, assignee, sort) {
...
], InquiryController.prototype, "assignees", null);
__decorate([
    (0, common_1.Get)(),
    ...
    __param(5, (0, common_1.Query)('assignee')),
    __param(6, (0, common_1.Query)('sort')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, String, String, String, String]),
    __metadata("design:returntype", void 0)
], InquiryController.prototype, "list", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", void 0)
], InquiryController.prototype, "get", null);
__decorate([
    (0, common_1.Post)(),
